...
public class MyManagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*这里往下*/ // 在这里需要设置的属性是
        ...
        g1.setImgurl("https://i.loli.net/2019/11/06/5qu3HmIG97MgOfA.jpg");
        list.add(g1);
        Good g2 = new Good(12,"铅笔","这是一根没有笔芯的铅笔");
        g2.setImgurl( "https://i.loli.net/2019/11/06/Ms2cPZDRmxEprFK.jpg");
        list.add(g2);
        Good g3 = new Good(10,"高数书","这是一本神奇的书，一本属于挂科人的书");
        g3.setImgurl("https://i.loli.net/2019/11/06/1fqml9XG4SE8cbC.jpg");
        list.add(g3);
        Good g4 = new Good(11,"耳机","在这里，你可以体验单声道的快乐");
        g4.setImgurl("https://i.loli.net/2019/11/06/f2UEVrWCNDmXhqx.jpg");
        list.add(g4);
